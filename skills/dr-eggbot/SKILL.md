...
It does not live in oss-factory. Keep a local checkout or marketplace install as `source: local`. This kit skill stays kit-owned and will update on `oss-onboard`.
