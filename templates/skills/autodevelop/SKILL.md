...
6. Run the unit command from `AGENTS.md`. Mutation only if it is not `n/a`.
7. Open a PR with the evidence receipt. **Never merge.** Independent review bots are not merge.
